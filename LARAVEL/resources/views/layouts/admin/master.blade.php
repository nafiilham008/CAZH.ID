...
<head>
    ...
    <script src="https://kit.fontawesome.com/7180ce34da.js" crossorigin="anonymous"></script>
    <!-- Ionicons -->
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning dropdown-toggle fas fa-user" data-toggle="dropdown"
                            aria-expanded="false">
